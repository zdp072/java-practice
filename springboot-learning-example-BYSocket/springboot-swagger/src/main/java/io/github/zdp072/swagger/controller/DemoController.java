package io.github.zdp072.swagger.controller;

import io.github.zdp072.swagger.beans.ResObject;
import io.github.zdp072.swagger.beans.User;
 ...
 * Hello world!
 */
@Api(value="API - DemoController", description = "用户接口")
@RestController
